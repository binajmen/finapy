defmodule FinapyWeb.CategoryController do
  use FinapyWeb, :controller

  alias Finapy.Categories
  alias Finapy.Categories.Category

  action_fallback FinapyWeb.FallbackController
